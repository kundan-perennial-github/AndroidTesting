...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    val mainActivityIntent = Intent.makeMainActivity(
        ComponentName(
            ...
            com.zaidzakir.androidtestingsample.HiltTestingActivity::class.java
        )
    ).putExtra(
    ...
    ActivityScenario.launch<com.zaidzakir.androidtestingsample.HiltTestingActivity>(mainActivityIntent).onActivity {activity->
        fragmentFactory?.let {
